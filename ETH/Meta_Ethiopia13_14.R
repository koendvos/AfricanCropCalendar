...
metadata$dataset_name <- "ETH_2013_ESS_v03_M"
metadata$dataset_doi <- "https://doi.org/10.48529/mccp-y123"
...
metadata$comment=c(
  ...
  "The value 13 describes the 13th month of the Ethiopian calendar Pagume (6th September - 10th September/ 11th Sepember in leap years), some months are 0", #"harvest_month_end",
  NA, #"adm1",
  NA, #"adm2",
  NA, #"adm3",  
  NA, #"lat",
...
write_csv(metadata, "out/ETH_2013-14_metadata.csv")
