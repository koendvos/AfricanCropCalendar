...
global Nigeria_GHS_W3_raw_data			"../data"
global Nigeria_GHS_W3_created_data 		"../out"
...
merge 1:1 hhid using "${Nigeria_GHS_W3_created_data}/Nigeria_GHS_W3_weights.dta", nogen keep(3) keepusing(weight)
ren LAT_DD_MOD lat
ren LON_DD_MOD lon
...
merge m:1 hhid using "${Nigeria_GHS_W3_created_data}/Nigeria_GHS_W3_weights.dta", nogen keep( 3)
...
use "${Nigeria_GHS_W3_raw_data}/secta3i_harvestw3.dta", clear
	...
	di "`var'"
		...
		export delimited using "../out/NGA_2015-16.csv", replace
