...
####################################################################################################################
    ...
    print('Prior to merge, MWI_2010_ag_mod_d_pd is of shape', MWI_2010_ag_mod_d_pd.shape)
    print('Prior to merge, MWI_2010_ag_mod_g_pd is of shape', MWI_2010_ag_mod_g_pd.shape)
    MWI_2010_major_pd = MWI_2010_ag_mod_d_pd.merge(MWI_2010_ag_mod_g_pd, on = MWI_2010_ag_mod_d.indexVar_lst, how = 'outer')
    print('After merge, MWI_2010_major_crop_pd is of shape', MWI_2010_major_pd.shape)
    # (b) Level: 'wave', 'season', 'hh_ID', 'plot_ID'
    print('Prior to merge, MWI_2010_ag_mod_c_pd is of shape', MWI_2010_ag_mod_c_pd.shape)
    MWI_2010_major_pd = MWI_2010_major_pd.merge(MWI_2010_ag_mod_c_pd, on = MWI_2010_ag_mod_c.indexVar_lst, how = 'left')
    ...
    # (a) Level: 'wave', 'season', 'hh_ID', 'plot_ID', 'crop'
    print('Prior to merge, MWI_2010_ag_mod_k_pd is of shape', MWI_2010_ag_mod_k_pd.shape)
    print('Prior to merge, MWI_2010_ag_mod_m_pd is of shape', MWI_2010_ag_mod_m_pd.shape)
    MWI_2010_minor_pd = MWI_2010_ag_mod_k_pd.merge(MWI_2010_ag_mod_m_pd, on = MWI_2010_ag_mod_k.indexVar_lst, how = 'outer')
    ...
    MWI_2010_minor_pd = MWI_2010_minor_pd.merge(MWI_2010_ag_mod_j_pd, on = MWI_2010_ag_mod_j.indexVar_lst, how = 'left')
    print('After merge, MWI_2010_minor_pd is of shape', MWI_2010_minor_pd.shape)
