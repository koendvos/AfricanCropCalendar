    ...
    'ag_mod_c': { 'indexVars': { 'hh_ID': 'case_id',
                    ...
                    'dataVars': {
                                 ...
                                 'areaPlotReported_unit': 'ag_c04b',
                                  'areaPlotGPS': 'ag_c04c', # (Area in Acres)
                                  },
                    'season': 'major',
    },
...
#                                 'cropHarvested_dum': 'ag_g07',
    ...
    'ag_mod_p': { 'indexVars': {'hh_ID': 'case_id',
                                'plot_ID': 'ag_p0b',
                                'crop': np.NaN,
                                'wave': np.NaN,
                                  },
                    'dataVars': {
                                # trees
                                'hhCultivated_dum': 'ag_p0a',
                                'cropCode': 'ag_p0d',
                                'cropCode_other': 'ag_p0d_os',
                                'cropStand': 'ag_p01',
                                'areaPlotReported': 'ag_p02a',
                                'areaPlotReported_unit': 'ag_p02b',
                                'areaPlotReported_unitOther': 'ag_p02b_os',
                                'seeding_year': 'ag_p04',
                                'harvestStart_month': 'ag_p06a',
                                'harvestStart_year': 'ag_p06b',
                                'harvestEnd_month': 'ag_p06c',
                                'harvestEnd_year': 'ag_p06d',
                                  },
                    'season': np.nan,
    },
...
modVar_dct_2013 = {
    ...
    'ag_mod_j_13': { 'indexVars': {'hh_ID': 'y2_hhid',
                    ...
                    'dataVars': {
                                  ...
                                  'areaPlotReported_unit': 'ag_j05b',
                                  'areaPlotGPS': 'ag_j05c', # (Area in Acres) 
                                  },
                    'season': 'minor',
    },
    ...
    'ag_mod_o2_13': { 'indexVars': {'hh_ID': 'y2_hhid',
                                'field_ID': 'ag_o03_2', # "2012/2013 garden id of the garden that the plot is a part of"
                                'plot_ID': 'ag_o00',
                                'wave': np.NaN,
                                  },
                    'dataVars': {
                                'hhCultivated_dum': 'ag_o01',
                                'areaPlotReported': 'ag_o04a',
                                'areaPlotReported_unit': 'ag_o04b',
                                'areaPlotGPS': 'ag_o04c',
                                  },
                    'season': np.nan,
    },
    'ag_mod_p_13': { 'indexVars': {
                                'hh_ID': 'y2_hhid',
                                # 'field_ID': np.NaN, # "2012/2013 garden id of the garden that the plot is a part of"
                                'plot_ID': 'ag_p00',
                                'crop': np.NaN,
                                'wave': np.NaN,
                                  },
                    'dataVars': {
                                # trees
                                # 'cropCode': 'ag_p0_crops',
                                'cropCode': 'ag_p0c',
                                # 'cropCode_other': 'ag_p0c_oth',
                                'cropStand': 'ag_p01',
                                # 'treeCrop_variety': 'ag_p01',
                                # 'treeCrop_variety_other': 'ag_p0aoth',
                                # 'areaPlotReported': 'ag_p02a',
                                # 'areaPlotReported_unit': 'ag_p02b',
                                # 'areaPlotReported_unitOther': 'ag_p02b_oth',
                                'seeding_year': 'ag_p04',
                                'harvestStart_month': 'ag_p06a',
                                'harvestStart_year': 'ag_p06b',
                                'harvestEnd_month': 'ag_p06c',
...
modVar_dct_2016 = {
    ...
    'ag_mod_o2': { 'indexVars': {'hh_ID': 'case_id',
                                'field_ID': 'gardenid',
                                'plot_ID': 'plotid',
                                'wave': np.NaN,
                                  },
                    'dataVars': {
                                ...
                                'areaPlotReported': 'ag_o04a',
                                'areaPlotReported_unit': 'ag_o04b',
                                'areaPlotReported_unitOther': 'ag_o04b_oth',
                                'areaPlotGPS': 'ag_o04c',
                                  },
                    'season': np.nan,
    },
...
modVar_dct_2019 = {
    ...
    #                               },
    #                 'dataVars': {
    #                             'plot_anyTrees': 'ag_d55_1',
    #                             'tree_mainType': 'ag_d55_2',
    #                             'tree_otherType': 'ag_d55_2oth',
    #                             'field_usage': 'ag_d14',
    #                             'crop01': 'ag_d20a',
    #                             'crop02': 'ag_d20b',
    #                             'crop03': 'ag_d20c',
    ...
    'ag_mod_g': { 'indexVars': {'hh_ID': 'case_id',
                    ...
                    'dataVars': {'cropCode': 'crop_code',
                                  ...
                                  'seeding_month': 'ag_g05a',
                                  'seeding_year': 'ag_g05b',
                                  # 'plot_cropPercHarvested': 'ag_g11_2',
                                  'harvestStart_month': 'ag_g12a',
                                  'harvestEnd_month': 'ag_g12b',
                                  },
                    'season': 'major',
...
cropNameHarmonize_dct_2010 = {
    ...
    'ag_mod_p': {'cropCols_lst': ['cropCode', 'cropCode_other'],
         'mainCropCol': 'cropCode',
        },
}
...
cropNameHarmonize_dct_2013 = {
    ...
    'ag_mod_p_13': {'cropCols_lst': ['cropCode'],
         'mainCropCol': 'cropCode',
        },
}
...
'zitheba': 'green beans',
'sorghum.': 'sorghum',
'tsabola': 'chili pepper',
'nseula': 'cowpeas',
'nkhungudzu': 'snow peas',
'rise wambone': 'rice',
'kalongonda': 'velvet bean',
#'msewula': '',
#'mphoza': '',
'mphonda': 'gourd',
'nkhaka': 'cucumber',
'green paper': 'green pepper',
#'chitheba': '',
'chitowe': 'cumin',
# 'kapile': '',
# 'kawala': '',
...
'sawawa': 'peas',
'rise ita': 'rice',
'mabilingano': 'eggplant',
'kambuzi pepper': 'chili pepper',
#######
'rice pussa': 'rice',
'nan': np.NaN,
'other (specify)': 'other',
...
MWI_2010_ag_mod_p = Module(country, wave_lst, panel_indexVars_lst, cropNameConvert_dct, 2010, Path( str(data_folder_LSMS), '2010_2011/MWI_2010_IHS-III_v01_M_STATA8_DtaToCsvExport'), 'MWI_2010_IHS-IV_v04_M', 'https://doi.org/10.48529/g2p9-9r19', modVar_dct_2010, cropNameHarmonize_dct_2010, 'ag_mod_p' )
...
MWI_2010_ag_mod_p_pd = MWI_2010_ag_mod_p.module_pd
...
MWI_2010_ag_mod_p.indexVar_lst
...
### merge gps-area into tree modules (in 2010 wave: gps area not separately recorded for tree-plots)
##########

# merge rainy-season GPS data into tree module
MWI_2010_tree_pd = MWI_2010_ag_mod_p_pd.merge( MWI_2010_ag_mod_c_pd.rename(
    {'areaPlotGPS': 'areaPlotGPS_rainy'}, axis = 1)[['wave', 'hh_ID', 'plot_ID', 'areaPlotGPS_rainy']], on = ['wave', 'hh_ID', 'plot_ID'], how = 'left', validate='m:1')

# merge dry-season GPS data into tree module
MWI_2010_tree_pd = MWI_2010_tree_pd.merge( MWI_2010_ag_mod_j_pd.rename(
    {'areaPlotGPS': 'areaPlotGPS_dry'}, axis = 1)[['wave', 'hh_ID', 'plot_ID', 'areaPlotGPS_dry']], on = ['wave', 'hh_ID', 'plot_ID'], how = 'left', validate='m:1')


# helper function: combine rainy-season & dry-season GPS data to single varaiable
def compute_areaPlotGPS(row):
    if pd.notna(row['areaPlotGPS_rainy']) and pd.notna(row['areaPlotGPS_dry']):
        return (row['areaPlotGPS_rainy'] + row['areaPlotGPS_dry']) / 2  # Average if both are valid
    elif pd.notna(row['areaPlotGPS_rainy']):
        return row['areaPlotGPS_rainy']  # Copy value from areaPlotGPS_rainy if only it is valid
    elif pd.notna(row['areaPlotGPS_dry']):
        return row['areaPlotGPS_dry']  # Copy value from areaPlotGPS_dry if only it is valid
    else:
        return np.nan  # Assign NaN if both are invalid

# combine rainy-season & dry-season GPS data to single varaiable
MWI_2010_tree_pd['areaPlotGPS'] = MWI_2010_tree_pd.apply(compute_areaPlotGPS, axis=1)

# drop helper columns
MWI_2010_tree_pd.drop(['areaPlotGPS_rainy', 'areaPlotGPS_dry'], axis = 1, inplace = True)



### ensure that data on last cultivated growing season is not incorrectly copied to tree data
##########
MWI_2010_tree_pd['lastMajor'] = np.nan
MWI_2010_tree_pd['lastMajor_hhCultOwn_dum'] = np.nan
MWI_2010_tree_pd['lastMinor'] = np.nan
MWI_2010_tree_pd['lastMinor_hhCultOwn_dum'] = np.nan



### merge info on last growing season into crop production data
##########
# (c) Level: 'wave', 'hh_ID'
...
### concat tree production to crop production
##########
MWI_2010_pd = pd.concat( [MWI_2010_pd, MWI_2010_tree_pd], axis=0, join="outer", ignore_index=True)
print('After concatenation of crop and tree production dataframes, MWI_2010_pd is of shape', MWI_2010_pd.shape)
...
# overwrite 'cropCode' with 'cropCode_other' if more informative
MWI_2010_pd.loc[ MWI_2010_pd['cropCode'] == 'other (specify', 'cropCode'] = MWI_2010_pd['cropCode_other']

# drop redundant column
MWI_2010_pd.drop('cropCode_other', axis=1, inplace=True)


### save wave to disk
##########
MWI_2010_pd.to_csv( Path( str(project_path), 'scripts', 'LSMS_MWI_ingested', 'MWI_2010_ingested.csv') )
...
MWI_2013_ag_mod_o2_13 = Module(country, wave_lst, panel_indexVars_lst, cropNameConvert_dct, 2013, Path( str(data_folder_LSMS), '2010_2013_panel/MWI_2010-2013_IHPS_v01_M_Stata_DtaToCsvExport'), 'MWI_2010-2013_IHPS_v01_M', 'https://doi.org/10.48529/4q9f-2288', modVar_dct_2013, cropNameHarmonize_dct_2013, 'ag_mod_o2_13' )
MWI_2013_ag_mod_p_13 = Module(country, wave_lst, panel_indexVars_lst, cropNameConvert_dct, 2013, Path( str(data_folder_LSMS), '2010_2013_panel/MWI_2010-2013_IHPS_v01_M_Stata_DtaToCsvExport'), 'MWI_2010-2013_IHPS_v01_M', 'https://doi.org/10.48529/4q9f-2288', modVar_dct_2013, cropNameHarmonize_dct_2013, 'ag_mod_p_13' )
...
MWI_2013_ag_mod_o2_13_pd = MWI_2013_ag_mod_o2_13.module_pd
MWI_2013_ag_mod_p_13_pd = MWI_2013_ag_mod_p_13.module_pd
...
MWI_2013_ag_mod_o2_13.indexVar_lst
MWI_2013_ag_mod_p_13.indexVar_lst
...
MWI_2013_ag_mod_o2_13.season
MWI_2013_ag_mod_p_13.season
...
### merge tree season modules (merge area variables into tree module)
##########
print('Starting merge for tree modules.')
# (a) Level: 'wave', 'hh_ID', 'field_ID', 'plot_ID', 'crop'
# (b) Level: 'wave', 'hh_ID', 'field_ID', 'plot_ID'
print('Prior to merge, MWI_2013_ag_mod_p_13_pd is of shape', MWI_2013_ag_mod_p_13_pd.shape)
print('Prior to merge, MWI_2013_ag_mod_o2_13_pd is of shape', MWI_2013_ag_mod_o2_13_pd.shape)
# MWI_2013_tree_pd = MWI_2013_ag_mod_p_13_pd.merge(MWI_2013_ag_mod_o2_13_pd, on = MWI_2013_ag_mod_o2_13.indexVar_lst, how = 'left', validate='m:1') # MWI_2013_ag_mod_p_13_pd does not contain a field ID
MWI_2013_tree_pd = MWI_2013_ag_mod_p_13_pd.merge(MWI_2013_ag_mod_o2_13_pd, on = ['hh_ID', 'plot_ID', 'wave'], how = 'left', validate='m:1')
print('After merge, MWI_2013_tree_pd is of shape', MWI_2013_tree_pd.shape)



### ensure that data on last cultivated growing season is not incorrectly copied to tree data
##########
MWI_2013_tree_pd['lastMajor'] = np.nan
MWI_2013_tree_pd['lastMajor_hhCultOwn_dum'] = np.nan
MWI_2013_tree_pd['lastMinor'] = np.nan
MWI_2013_tree_pd['lastMinor_hhCultOwn_dum'] = np.nan
...
### concat tree production to crop production
##########
MWI_2013_pd = pd.concat( [MWI_2013_pd, MWI_2013_tree_pd], axis=0, join="outer", ignore_index=True)
print('After concatenation of crop and tree production dataframes, MWI_2013_pd is of shape', MWI_2013_pd.shape)
...
### overwrite 2013-specific household-identifier with 2010-specific household identifier (i.e., from IHS3)
##########

# drop redundant household-IDs
MWI_2013_pd.drop(['hh_ID', 'hh_ID3'], axis=1, inplace=True)
# elevate relevant household-ID to be stored as 'hh_ID'
MWI_2013_pd.rename({'hh_ID2': 'hh_ID'}, axis=1, inplace=True)



### save wave to disk
##########
MWI_2013_pd.to_csv( Path( str(project_path), 'scripts', 'LSMS_MWI_ingested', 'MWI_2013_ingested.csv') )
...
MWI_2016_ag_mod_o2 = Module(country, wave_lst, panel_indexVars_lst, cropNameConvert_dct, 2016, Path( str(data_folder_LSMS), '2016_2017/MWI_2016_IHS-IV_v04_M_STATA14_DtaToCsvExport'), 'MWI_2016_IHS-IV_v04_M', 'https://doi.org/10.48529/g2p9-9r19', modVar_dct_2016, cropNameHarmonize_dct_2016, 'ag_mod_o2' )
MWI_2016_ag_mod_p = Module(country, wave_lst, panel_indexVars_lst, cropNameConvert_dct, 2016, Path( str(data_folder_LSMS), '2016_2017/MWI_2016_IHS-IV_v04_M_STATA14_DtaToCsvExport'), 'MWI_2016_IHS-IV_v04_M', 'https://doi.org/10.48529/g2p9-9r19', modVar_dct_2016, cropNameHarmonize_dct_2016, 'ag_mod_p' )
...
MWI_2016_ag_mod_o2_pd = MWI_2016_ag_mod_o2.module_pd
MWI_2016_ag_mod_p_pd = MWI_2016_ag_mod_p.module_pd
...
MWI_2016_ag_mod_o2.indexVar_lst
MWI_2016_ag_mod_p.indexVar_lst
...
MWI_2016_ag_mod_o2.season
MWI_2016_ag_mod_p.season
...
MWI_2016_major_pd = MWI_2016_ag_mod_g_pd.merge(MWI_2016_ag_mod_c_pd, on = MWI_2016_ag_mod_c.indexVar_lst, how = 'left', validate='m:1')
...
MWI_2016_minor_pd = MWI_2016_ag_mod_m_pd.merge(MWI_2016_ag_mod_j_pd, on = MWI_2016_ag_mod_j.indexVar_lst, how = 'left', validate='m:1')
...
# (a) Level: 'wave', 'hh_ID', 'field_ID', 'plot_ID', 'crop'
# (b) Level: 'wave', 'hh_ID', 'field_ID', 'plot_ID'
print('Prior to merge, MWI_2016_ag_mod_p_pd is of shape', MWI_2016_ag_mod_p_pd.shape)
print('Prior to merge, MWI_2016_ag_mod_o2_pd is of shape', MWI_2016_ag_mod_o2_pd.shape)
MWI_2016_tree_pd = MWI_2016_ag_mod_p_pd.merge(MWI_2016_ag_mod_o2_pd, on = MWI_2016_ag_mod_o2.indexVar_lst, how = 'left', validate='m:1')
print('After merge, MWI_2016_tree_pd is of shape', MWI_2016_tree_pd.shape)



### ensure that data on last cultivated growing season is not incorrectly copied to tree data
##########
MWI_2016_tree_pd['lastMajor'] = np.nan
MWI_2016_tree_pd['lastMajor_hhCultOwn_dum'] = np.nan
MWI_2016_tree_pd['lastMinor'] = np.nan
MWI_2016_tree_pd['lastMinor_hhCultOwn_dum'] = np.nan
...
### concat tree production to crop production
##########
MWI_2016_pd = pd.concat( [MWI_2016_pd, MWI_2016_tree_pd], axis=0, join="outer", ignore_index=True)
print('After concatenation of crop and tree production dataframes, MWI_2016_pd is of shape', MWI_2016_pd.shape)
...
### save wave to disk
##########
MWI_2016_pd.to_csv( Path( str(project_path), 'scripts', 'LSMS_MWI_ingested', 'MWI_2016_ingested.csv') )
...
MWI_2019_ag_mod_o2 = Module(country, wave_lst, panel_indexVars_lst, cropNameConvert_dct, 2019, Path( str(data_folder_LSMS), '2019_2020/MWI_2019_IHS-V_v05_M_Stata_DtaToCsvExport'), 'MWI_2019_IHS-V_v05_M', 'https://doi.org/10.48529/yqn3-zv74', modVar_dct_2019, cropNameHarmonize_dct_2019, 'ag_mod_o2' )
MWI_2019_ag_mod_p = Module(country, wave_lst, panel_indexVars_lst, cropNameConvert_dct, 2019, Path( str(data_folder_LSMS), '2019_2020/MWI_2019_IHS-V_v05_M_Stata_DtaToCsvExport'), 'MWI_2019_IHS-V_v05_M', 'https://doi.org/10.48529/yqn3-zv74', modVar_dct_2019, cropNameHarmonize_dct_2019, 'ag_mod_p' )
...
MWI_2019_ag_mod_o2_pd = MWI_2019_ag_mod_o2.module_pd
MWI_2019_ag_mod_p_pd = MWI_2019_ag_mod_p.module_pd
...
MWI_2019_ag_mod_o2.indexVar_lst
MWI_2019_ag_mod_p.indexVar_lst
...
MWI_2019_ag_mod_o2.season
MWI_2019_ag_mod_p.season
...
MWI_2019_major_pd = MWI_2019_ag_mod_g_pd.merge(MWI_2019_ag_mod_c_pd, on = MWI_2019_ag_mod_c.indexVar_lst, how = 'left', validate='m:1')
...
MWI_2019_minor_pd = MWI_2019_ag_mod_m_pd.merge(MWI_2019_ag_mod_j_pd, on = MWI_2019_ag_mod_j.indexVar_lst, how = 'left')
...
# (a) Level: 'wave', 'hh_ID', 'field_ID', 'plot_ID', 'crop'
# (b) Level: 'wave', 'hh_ID', 'field_ID', 'plot_ID'
print('Prior to merge, MWI_2019_ag_mod_p_pd is of shape', MWI_2019_ag_mod_p_pd.shape)
print('Prior to merge, MWI_2019_ag_mod_o2_pd is of shape', MWI_2019_ag_mod_o2_pd.shape)
MWI_2019_tree_pd = MWI_2019_ag_mod_p_pd.merge(MWI_2019_ag_mod_o2_pd, on = MWI_2019_ag_mod_o2.indexVar_lst, how = 'left', validate='m:1')
print('After merge, MWI_2019_tree_pd is of shape', MWI_2019_tree_pd.shape)



### ensure that data on last cultivated growing season is not incorrectly copied to tree data
##########
MWI_2019_tree_pd['lastMajor'] = np.nan
MWI_2019_tree_pd['lastMajor_hhCultOwn_dum'] = np.nan
MWI_2019_tree_pd['lastMinor'] = np.nan
MWI_2019_tree_pd['lastMinor_hhCultOwn_dum'] = np.nan
...
### concat tree production to crop production
##########
MWI_2019_pd = pd.concat( [MWI_2019_pd, MWI_2019_tree_pd], axis=0, join="outer", ignore_index=True)
print('After concatenation of crop and tree production dataframes, MWI_2019_pd is of shape', MWI_2019_pd.shape)
...
### save wave to disk
##########
MWI_2019_pd.to_csv( Path( str(project_path), 'scripts', 'LSMS_MWI_ingested', 'MWI_2019_ingested.csv') )
...
panel_MWI_pd = pd.concat( [MWI_2010_pd, MWI_2013_pd, MWI_2016_pd, MWI_2019_pd], axis=0, join="outer", ignore_index=True )
...
panel_MWI_pd['dataset_name'] = np.NaN
panel_MWI_pd['dataset_doi'] = np.NaN

panel_MWI_pd.loc[ panel_MWI_pd['wave'] == 2010, 'dataset_name'] = MWI_2010.dataset_name
panel_MWI_pd.loc[ panel_MWI_pd['wave'] == 2010, 'dataset_doi'] = MWI_2010.dataset_doi
panel_MWI_pd.loc[ panel_MWI_pd['wave'] == 2013, 'dataset_name'] = MWI_2013.dataset_name
panel_MWI_pd.loc[ panel_MWI_pd['wave'] == 2013, 'dataset_doi'] = MWI_2013.dataset_doi
panel_MWI_pd.loc[ panel_MWI_pd['wave'] == 2016, 'dataset_name'] = MWI_2016.dataset_name
panel_MWI_pd.loc[ panel_MWI_pd['wave'] == 2016, 'dataset_doi'] = MWI_2016.dataset_doi
panel_MWI_pd.loc[ panel_MWI_pd['wave'] == 2019, 'dataset_name'] = MWI_2019.dataset_name
panel_MWI_pd.loc[ panel_MWI_pd['wave'] == 2019, 'dataset_doi'] = MWI_2019.dataset_doi

### save panel to disk
panel_MWI_pd.to_csv( Path( str(project_path), 'scripts', 'LSMS_MWI_ingested', 'MWI_panel_ingested.csv' ), index=False )
