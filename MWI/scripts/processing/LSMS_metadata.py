...
for wave_tmp in panel_MWI.wave_lst:
    ...
    for varName_harmonized in varName_harmonized_lst:
        ...
        ##########
        if varName_harmonized in ['wave', 'country', 'adm3', 'adm4', 'GPS_level', 'harvest_year', 'harvest_month', 'dataset_name', 'dataset_doi']:
...
metadata_pd.loc[ metadata_pd['varName_harmonized'] == 'adm2', 'comment'] = 'Second-level administrative divisions identify Local Government Areas as defined by the Local Government Act of Malawi and used for reporting by the National Statistical Office of Malawi.'
